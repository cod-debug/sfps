...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				<a href="index.php?page=home" class="nav-item nav-home" style="size: 30%;"><span class='icon-field'><i class="fa fa-tachometer-alt "></i></span> Dashboard</a>
				...
				<a href="index.php?page=admin_online_payments&status=pending" class="nav-item nav-admin_online_payments"><span class='icon-field'><i class="fa fa-receipt "></i></span> Online Payments</a>
				<div class="mx-2 text-white">Master List</div>
				<a href="index.php?page=course_list" class="nav-item nav-course_list"><span class='icon-field'><i class="fa fa-scroll "></i></span> Course List</a>
