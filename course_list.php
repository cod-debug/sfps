					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$course = $conn->query("SELECT * FROM course_list  order by course_name asc ");
								...
								<tr>
									...
									<td class="">
										 <p><small><i><b><?php echo $row['course_short_name'] ?></i></small></p>
									</td>
									<?php if($_SESSION['login_type'] == 1): ?>
...
<script>
	...
	$('#new_course').click(function(){
		uni_modal("New Course","manage_course_list.php",'medium')
